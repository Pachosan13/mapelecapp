...
// bombas debe reflejar el inventario REAL del edificio, no una plantilla fija. Se apoya en
// la precarga de equipos (tabla `equipment`, columnas `system` y `kind`):
...
// (sin conteo por unidad). Los grupos por-unidad (principales/reforzadoras/sumergibles) se
// resuelven aparte en `itemAppliesToBuilding`.
...
// render y en el server action `handleResponses` para que guardado/validación no se desincronicen.
const itemAppliesToBuilding = (label: string, scope: BuildingScope) => {
